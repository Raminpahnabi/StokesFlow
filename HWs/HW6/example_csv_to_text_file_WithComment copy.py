...
def OutputStudentEvaluations(filename,input_folder,output_folder):
    ...
    feedback_filename = "Homework_6_Feedback.txt"
    ...
    full_score_line = 23 # index of the line with the student score
    ...
    for i in range(first_student_column,len(lines[0])):
        ...
        with open(out_file, 'w') as f:              #the same as the previous one for read
            f.write("======================\n")
            f.write("Feedback on Homework 6\n")
            f.write("======================\n")
...
input_folder = "Solution_H_6"  # this folder(Solution_H_4) should be created in the
                               # same folder as this  python file folder
student_evaluations = "Homework_6.csv" # should be lacated in the input_folder
